...
class CfgWeapons {
    ...
    class srifle_LRR_tna_F_OCimport_01 : srifle_LRR_tna_F { scope = 0; class EventHandlers; class WeaponSlotsInfo; };
    ...
    class amrifle_alligator_b_OCimport_01 : amrifle_alligator_b { access = 0; scope = 0; class EventHandlers; class Single; };
