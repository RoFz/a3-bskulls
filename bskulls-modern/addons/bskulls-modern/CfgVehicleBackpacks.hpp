    ...
    class B_PTbskull_Veh_Back_TL_blackops_01: THC_Bag50 {
        ...
        class TransportMagazines {
            ...
            class _xx_B_PTbskull_Wea_sniper_03_falkor_AMMO {count=12;magazine=QUOTE(B_PTbskull_Wea_sniper_03_falkor_AMMO);};
    ...
    class B_PTbskull_Veh_Back_TL_blackops_02: THC_Bag50 {
        ...
        class TransportMagazines {
            class _xx_B_IR_Grenade {count=1;magazine="B_IR_Grenade";};
            class _xx_Laserbatteries {count=1;magazine="Laserbatteries";};
            class _xx_B_PTbskull_Wea_sniper_08_wa2000_AMMO {count=20;magazine=QUOTE(B_PTbskull_Wea_sniper_08_wa2000_AMMO);};
            class _xx_8Rnd_SPAS12_buck {count=5;magazine=QUOTE(B_PTbskull_Wea_shotgun_2_spas_AMMO);};
            VIPER_BAG_MAGAZINES
        };
        class TransportItems {VIPER_BAG_ITEMS};
    ...
    class B_PTbskull_Veh_Back_TL_blackops_03: THC_Bag50 {
        ...
        class TransportMagazines {
            class _xx_B_IR_Grenade {count=1;magazine="B_IR_Grenade";};
            class _xx_Laserbatteries {count=1;magazine="Laserbatteries";};
            class _xx_B_PTbskull_Wea_sniper_01_m110_AMMO {count=6;magazine=QUOTE(B_PTbskull_Wea_sniper_01_m110_AMMO);};
            class _xx_8Rnd_SPAS12_buck {count=5;magazine=QUOTE(B_PTbskull_Wea_shotgun_2_spas_AMMO);};
            VIPER_BAG_MAGAZINES
        };
        class TransportItems {VIPER_BAG_ITEMS};
    ...
    class B_PTbskull_Veh_Back_TL_blackops_06: THC_Bag50 {
        ...
        class TransportMagazines {
            class _xx_B_IR_Grenade {count=1;magazine="B_IR_Grenade";};
            class _xx_Laserbatteries {count=1;magazine="Laserbatteries";};
            class _xx_B_PTbskull_Wea_sniper_05_vssk_AMMO {count=24;magazine=QUOTE(B_PTbskull_Wea_sniper_05_vssk_AMMO);};
            class _xx_B_PTbskull_Wea_shotgun_3_benelli_AMMO {count=6;magazine=QUOTE(B_PTbskull_Wea_shotgun_3_benelli_AMMO);};
            VIPER_BAG_MAGAZINES
        };
        class TransportItems {VIPER_BAG_ITEMS};
    ...
    class B_PTbskull_Veh_Back_TL_blackops_07: THC_Bag50 {
        author = "RoFz";
        scope = 2;
        displayName = "Assault Pack (Viper ASP-1 + Benelli M1014)";
        maximumLoad = 2000;
        hiddenSelectionsTextures[] = {"\A3\weapons_f\ammoboxes\bags\data\backpack_compact_blk_co.paa"};
        model = "\A3\weapons_f\Ammoboxes\bags\Backpack_Compact";
        picture = "\A3\weapons_f\ammoboxes\bags\data\ui\icon_B_C_Compact_blk_ca.paa";
        class TransportMagazines {
            class _xx_B_IR_Grenade {count=1;magazine="B_IR_Grenade";};
            class _xx_Laserbatteries {count=1;magazine="Laserbatteries";};
            class _xx_B_PTbskull_Wea_sniper_06_asp1_AMMO {count=12;magazine=QUOTE(B_PTbskull_Wea_sniper_06_asp1_AMMO);};
            class _xx_B_PTbskull_Wea_shotgun_3_benelli_AMMO {count=6;magazine=QUOTE(B_PTbskull_Wea_shotgun_3_benelli_AMMO);};
            VIPER_BAG_MAGAZINES
        };
        class TransportItems {VIPER_BAG_ITEMS};
    ...
    class B_PTbskull_Veh_Back_TL_blackops_08: THC_Bag50 {
        ...
        class TransportMagazines {
            class _xx_B_IR_Grenade {count=1;magazine="B_IR_Grenade";};
            class _xx_Laserbatteries {count=1;magazine="Laserbatteries";};
            class _xx_B_PTbskull_Wea_sniper_04_m320_AMMO {count=17;magazine=QUOTE(B_PTbskull_Wea_sniper_04_m320_AMMO);};
            class _xx_B_PTbskull_Wea_shotgun_3_benelli_AMMO {count=6;magazine=QUOTE(B_PTbskull_Wea_shotgun_3_benelli_AMMO);};
            VIPER_BAG_MAGAZINES
        };
        class TransportItems {VIPER_BAG_ITEMS};
    ...
    class B_PTbskull_Veh_Back_SNIPER_blackops_01: THC_Bag50 {
        ...
        class TransportMagazines {
            class _xx_MiniGrenade {count=2;magazine="MiniGrenade";};
            class _xx_B_PTbskull_Wea_sniper_02_trg42_AMMO {count=15;magazine=QUOTE(B_PTbskull_Wea_sniper_02_trg42_AMMO);};
            class _xx_B_PTbskull_Wea_SMG_02_sting_AMMO {count=3;magazine=QUOTE(B_PTbskull_Wea_SMG_02_sting_AMMO);};
        };
        class TransportItems { };
        class TransportWeapons {
   ...
   class B_PTbskull_Veh_Back_AT_blackops_01: THC_Bag50 {
        ...
        picture = "\A3\weapons_f\ammoboxes\bags\data\ui\icon_B_C_Compact_blk_ca.paa";
        class TransportMagazines {
            class _xx_Titan_AT_PLUS {count=5;magazine="Titan_AT_PLUS";};
        };
        class TransportItems { };
        class TransportWeapons { };
    };

   class B_PTbskull_Veh_Back_AT_blackops_02: THC_Bag50 {
        author = "RoFz";
        scope = 2;
        displayName = "Assault Pack (Archangel)";
        maximumLoad = 2000;
        hiddenSelectionsTextures[] = {"\A3\weapons_f\ammoboxes\bags\data\backpack_compact_blk_co.paa"};
        model = "\A3\weapons_f\Ammoboxes\bags\Backpack_Compact";
        picture = "\A3\weapons_f\ammoboxes\bags\data\ui\icon_B_C_Compact_blk_ca.paa";
        class TransportMagazines {
            class _xx_Titan_AT_TOP_PLUS {count=5;magazine="Titan_AT_TOP_PLUS";};
        };
        class TransportItems { };
        class TransportWeapons { };
    };
   ...
   class B_PTbskull_Veh_Back_AMMO_blackops_01: THC_Bag50 {
        ...
        picture = "\A3\weapons_f\ammoboxes\bags\data\ui\icon_B_C_Compact_blk_ca.paa";
        class TransportMagazines {
            class _xx_Titan_AT_PLUS {count=1;magazine="Titan_AT_PLUS";};
            class _xx_Titan_AA {count=1;magazine="Titan_AA";};
            class _xx_HandGrenade {count=2;magazine="HandGrenade";};
            class _xx_MiniGrenade {count=2;magazine="MiniGrenade";};
            class _xx_B_IR_Grenade {count=1;magazine="B_IR_Grenade";};
            class _xx_KA_SCAR_H_20rnd_M993_AP_mag {count=10;magazine="KA_SCAR_H_20rnd_M993_AP_mag";};
            class _xx_hlc_50rnd_300BLK_STANAG_EPR {count=4;magazine="hlc_50rnd_300BLK_STANAG_EPR";};
            class _xx_JAS_RSASS_20rnd_M993_AP_mag {count=2;magazine="JAS_RSASS_20rnd_M993_AP_mag";};
            class _xx_ICM_XM7_Magazine_277_Fury_BP_F {count=2;magazine="ICM_XM7_Magazine_277_Fury_BP_F";};
            class _xx_20Rnd_762x51_Mag {count=3;magazine="20Rnd_762x51_Mag";};
            class _xx_B_PTbskull_Wea_SMG_02_sting_AMMO {count=3;magazine=QUOTE(B_PTbskull_Wea_SMG_02_sting_AMMO);};
            class _xx_B_PTbskull_Wea_sniper_02_trg42_AMMO {count=2;magazine=QUOTE(B_PTbskull_Wea_sniper_02_trg42_AMMO);};
            class _xx_10Rnd_300WM_Magazine {count=4;magazine="10Rnd_300WM_Magazine";};
            ...
            class _xx_10Rnd_93x64_DMR_05_Mag {count=2;magazine="10Rnd_93x64_DMR_05_Mag";};
            class _xx_150Rnd_93x64_Mag {count=1;magazine="150Rnd_93x64_Mag";};
            class _xx_130Rnd_338_Mag {count=1;magazine="130Rnd_338_Mag";};
            class _xx_B_PTbskull_Wea_mg_04_xm250_AMMO {count=1;magazine=QUOTE(B_PTbskull_Wea_mg_04_xm250_AMMO);};
            class _xx_B_PTbskull_Wea_mg_3_AMMO {count=1;magazine=QUOTE(B_PTbskull_Wea_mg_3_AMMO);};
        };
        class TransportItems { };
        class TransportWeapons { };
    };
